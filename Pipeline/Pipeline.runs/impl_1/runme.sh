...
HD_PWD='S:/360Downloads/Pipeline/Pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsPipelineCPU.vdi -applog -m64 -messageDb vivado.pb -mode batch -source MipsPipelineCPU.tcl -notrace
