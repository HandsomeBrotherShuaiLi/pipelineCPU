...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot dataRAM xil_defaultlib.dataRAM xil_defaultlib.glbl -log elaborate.log
}
